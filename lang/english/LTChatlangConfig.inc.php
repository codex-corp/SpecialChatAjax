<?
  ...
  define("ChFun_team_members_online","<span style=\"color: blue; font-family: arial; font-size: 10pt;\"><b>Team of the members online</b> <a style=\"text-decoration: none\" href=\"javascript:parent.message('/#nick#')\"><font color='#levelcolor#' font='#nickfont#'>#nick#,</font></a></span>");
  ...
  define("waitmsg","<FONT face='Palatino Linotype' size='3' color=red>Nickname wait :<font color=ffffff>i</font><a style=\'text-decoration: none; color: cc0000\' <a onclick='parent.message(\"/msg #waitname# \")' href=\"#\"><font color='#FF0000'>#waitname#</font></a><font color=ffffff>i</font>(#waitright#) is currently on the chat in room <a style=\'text-decoration: none; color: cc0000\' onclick='parent.message(\"/room #joinedroom# \")' href=\"#\"><font color='#FF0000'>#joinedroom#</font></a> !</FONT>");
...
//------------------------ sus -----------------------------
  ...
  define("ChFun_sus_offline", "Sorry, user \"#user#\" cannot online for kicked him right now!");
########################## sus #############################
...
//------------------------ unsus -----------------------------
  ...
  define("ChFun_un_sused", "<font face='Arial' size='2' color='AAAAAA'>The Operator <strong>(#user#)</strong> un-suspension from chat by <strong>#sender#</strong>, a suspension originally done by <strong>#sender_original#</strong> !.</font>");
...
//command sing
  define("ChFun_sing_msg","<span style='visibility:hidden; font-size:xx-small'>i</span><font face='#my_nick_font#' color='#my_nick_color#' size='2'><b>#user#</b> </font><strong><font face='Tahoma' size='4' color='#008000'>sings,</font></strong><img src='#LTChatTemplatePath#img/song_ne.gif'>&nbsp;<font face=#my_font# color=#my_color#><b><i>#text#</i></b></font>&nbsp;<img src='#LTChatTemplatePath#img/song_ne.gif'><span style='visibility:hidden; font-size:xx-small'>i</span>");
//command sing error
