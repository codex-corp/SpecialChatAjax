...
graphicsDir : 'http://127.0.0.1/chat/templates/standard/highslide/graphics/',
...
var s ='<div class="highslide-header"><table width="400px" border="0" cellpadding=0 cellspacing=0>'
	+	'<tr>'
	+	'<td width="1%">'
	+	'<img border="0" src="'+hs.graphicsDir+'top_left.gif" width="13" height="47"></td>'
	+	'<td background="'+hs.graphicsDir+'bg_header.gif" width="6%">'
	+	'<img border="0" src="'+hs.graphicsDir+'logo.gif" width="39" height="47"></td>'
	+	'<td background="'+hs.graphicsDir+'bg_header.gif" width="91%"><ul>'
	+	'<li class="highslide-move"><a href="#" onclick="return false">'+ hs.moveText +'</a></li>'
	+	'<li class="highslide-close"><a onclick="return hs.close(this)" title="'+ hs.closeTitle +'" href="#">'+ hs.closeText +'</a></li>'
	+	'</ul>'
	+	'</td>'
	+	'<td width="1%">'
	+	'<img border="0" src="'+hs.graphicsDir+'top_right.gif" width="13" height="47"></td>'
	+	'</tr>'
	+	'<tr>'
	+	'<td height="177" width="1%" background="'+hs.graphicsDir+'bg_left.gif">&nbsp;</td>'
	+	'<td style="width:100%; height:100%;" bgcolor="#F2F2F2" colspan="2"><div class="highslide-body"></div></td>'
	+	'<td width="1%" height="177" background="'+hs.graphicsDir+'bg_right.gif">&nbsp;</td>'
	+	'</tr>'
	+	'<tr>'
	+	'<td width="1%" style="background:url('+hs.graphicsDir+'footer_left.gif) no-repeat">&nbsp;</td>'
	+	'<td style="background:url('+hs.graphicsDir+'footer_bg.gif) repeat-x" colspan="2"></td>'
	+	'	<td style="background:url('+hs.graphicsDir+'footer_right.gif) no-repeat"><div class="highslide-footer"><div><span class="highslide-resize" title="'+ hs.resizeTitle +'"><span></td>'
	+	'</tr>'
    +	'</table></div>';
