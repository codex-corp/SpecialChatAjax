...
//   }
	...
	{	
	    ...
	    newdiv.innerHTML = "<table height=\"100%\"  width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\"><tr><td bgcolor=\"#71828A\"><img alt='close this internal window' style=\"margin-left:10px;\" src=\"./templates/standard/img/close.gif\" onClick=\"remove_element('board');return false\" width=\"24\" height=\"24\" /><img alt='alert' style=\"margin-left:15px;\" src=\"./templates/standard/img/alert.gif\" onClick=\"remove_element('board');return false\" width=\"24\" height=\"24\" /></td></tr><tr><td style=\"width:100%; height:100%;\"><iframe style=\"width:100%; height:100%;\" frameborder=\"0\" scrolling=\"auto\" src=\"command_tpl.php?load_template="+data['load_template']+"&other_vars="+data['other_vars']+"\"></iframe></td></tr></table>";
